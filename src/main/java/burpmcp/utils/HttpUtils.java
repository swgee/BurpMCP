...
public class HttpUtils {
    ...
    public static HttpMode getHttpMode(String httpVersion) {
    ...
    public static HttpRequest buildHttpRequest(Map<String, Object> args) {
        ...
        if (httpMode == HttpMode.HTTP_2) {
            ...
            return HttpRequest.httpRequest(httpService, ByteArray.byteArray(method + " " + path + " HTTP/1.1\r\n" + headers + "\r\n\r\n" + body));
        }
    }
} 